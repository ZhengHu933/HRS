<%-- 
    Document   : index
    Created on : Sep 1, 2018, 12:17:25 AM
    Author     : Jesse
--%>
...
<script>
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyA2js95juCSBAMSxuni5Ld_pEsW-d7EkGo",
    authDomain: "hospital-reservation-system.firebaseapp.com",
    databaseURL: "https://hospital-reservation-system.firebaseio.com",
    projectId: "hospital-reservation-system",
    storageBucket: "hospital-reservation-system.appspot.com",
    messagingSenderId: "89913278078"
  };
...
<script> firebase.auth().onAuthStateChanged(function(user){
    if(user) {
        ...
        $("#lgbtn").click(function(){window.location.href="account.jsp";});
         $("#smbtn").html("Log out");
         ...
         $("#lgbtn").html("Log in");
         $("#lgbtn").click(function(){window.location.href="login.jsp";});
         $("#smbtn").html("Sign up");
         $("#smbtn").click(function(){window.location.href="signup.jsp";});
    }
        });
          </script>
